    ...
    <div className="p-2 flex flex-col items-center">
      ...
      >
        ...
        {small && (
          <>
            <p
              className={`text-white text-[0.5rem] md:text-xs absolute bottom-2 left-0 z-[100] text-center w-full`}
            >
              {name}
            </p>
            <div className="w-full h-[50%] md:h-[35%] bg-gradient-to-t from-[rgba(0,0,0,1)] to-[rgba(0,0,0,0)] absolute bottom-0 left-0 z-[80] "></div>
          </>
        )}
      </div>
      <p
